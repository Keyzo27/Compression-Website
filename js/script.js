document.addEventListener('DOMContentLoaded', function () {
    ...
    compressButton.addEventListener('click', () => {
        ...
        }, 3000); // Animasi loading akan tampil selama 3 detik sebelum proses kompresi dimulai
    });
    ...
    function displayFileInfo(files) {
        ...
        fileInfoContainer.innerHTML = '<h3>File yang Anda masukkan:</h3>'; // Clear previous info
